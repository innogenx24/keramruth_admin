  ...
  const handleConfirmDelete = async () => {
    if (selectedNews) {
      try {
        ...
        setMediaNews((prev) =>
          prev.filter((item) => item.id !== selectedNews.id)
        );
  ...
  return (
    <div style={{ padding: "20px" }}>
        ...
        <Table>
          <TableHead sx={{ backgroundColor: "#DCDCDC" }}>
            <TableRow style={{ whiteSpace: "nowrap" }}>
              ...
              {role === "Admin" && <TableCell>Applying on</TableCell>}
              ...
              mediaNews
                ...
                .map((news, index) => (
                  <TableRow key={news.id}>
                    ...
                    {role === "Admin" && (
                      <TableCell>{news.receiver.join(", ")}</TableCell>
                    )}
                    {role === "Admin" && (
                      <TableCell>
      ...
      <Dialog open={openDeleteModal} onClose={handleCancelDelete}>
        ...
        <DialogContent>
          <Typography>
            Are you sure you want to delete the Media/News "
