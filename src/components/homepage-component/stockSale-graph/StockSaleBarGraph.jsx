            ...
            datasets: [
              {
                ...
                data: achievedAmount,
                backgroundColor: "rgba(1, 197, 114, 1)", // Dark Green
                stack: "amount",
                barThickness: 25,
                borderRadius: 4,
              },
              ...
              {
                label: "Stock Achieved",
                data: soldStockAmount,
                backgroundColor: "#FF3535", // Dark Red
                stack: "stock",
                barThickness: 25,
                borderRadius: 4,
              },
  ...
  const options = {
    ...
    plugins: {
      legend: {
        ...
        position: "top",
        labels: {
          usePointStyle: true, // Ensures rounded legend markers
          boxWidth: 10, // Reduces marker size
          padding: 15, // Adjusts spacing
        },
      },
      tooltip: {
        callbacks: {
          label: function (data) {
            return "Rs. " + new Intl.NumberFormat("en-IN").format(data.raw);
          },
        },
      },
    },
